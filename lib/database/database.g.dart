    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Transaction` (`id` INTEGER NOT NULL, `date` TEXT NOT NULL, `description` TEXT NOT NULL, `price` TEXT NOT NULL, `passbookRange` INTEGER NOT NULL, PRIMARY KEY (`id`))');
...
class _$TransactionDao extends TransactionDao {
    ...
    this.changeListener,
        ...
        _transactionInsertionAdapter = InsertionAdapter(
            ...
            (Transaction item) => <String, Object?>{
                  ...
                  'price': item.price,
                  'passbookRange': item.passbookRange
                });
  ...
  @override
  Future<void> insertPerson(Transaction transaction) async {
